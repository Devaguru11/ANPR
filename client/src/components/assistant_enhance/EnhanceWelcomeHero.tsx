...
const QUICK_ACTIONS = [
  { label: "Detections yesterday", message: "How many detections yesterday" },
  { label: "Violations at Chowking", message: "Show all violations at Chowking" },
  { label: "30-day violation trend", message: "Show violation trend for last 30 days" },
];
    ...
    >
      ...
      <Box sx={{ flex: 1, minWidth: 0 }}>
        ...
        <Typography sx={{ fontSize: "0.875rem", color: chatUi.textSecondary, lineHeight: 1.55, mb: 2 }}>
          I&apos;m your Analytics Assistant. Ask about violations, detections, trends, and comparisons using
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1 }}>
          {QUICK_ACTIONS.map((a) => (
            <Box
              ...
              component="button"
              type="button"
              onClick={() => !disabled && onPrompt(a.message)}
              disabled={disabled}
              sx={{
